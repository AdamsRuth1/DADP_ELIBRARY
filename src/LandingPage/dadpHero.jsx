        ...
        <div className="backdrop-blur-sm bg-white/40 p-4 md:p-12 rounded-[2rem] md:rounded-[3rem] border border-white/50 shadow-2xl flex flex-row items-center gap-4 md:gap-16">
          <div className="flex-[1.5] text-left">
            ...
            <p className="text-[10px] md:text-lg text-gray-700 leading-tight md:leading-relaxed font-medium mb-4 md:mb-8">
              Pioneering the digital frontier. DADP stands at the forefront of automated systems and cyber security.
            </p>
            <div className="flex flex-col md:flex-row gap-2 md:gap-4">
              <a href="/elibrary" className="bg-[#1F3D2B] text-white px-2 md:px-8 py-2 md:py-3 rounded-lg md:xl font-bold text-[8px] md:text-base text-center">
                eLibrary
              </a>
              <a href="#courses" className="border border-[#1F3D2B] text-[#1F3D2B] px-2 md:px-8 py-2 md:py-3 rounded-lg md:xl font-bold text-[8px] md:text-base text-center">
                Courses
              </a>
            </div>
          </div>
